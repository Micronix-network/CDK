...
<div id="propstabs_${cardId}" style="min-height:300px;">
    ...
    <div id="propstabs-1_${cardId}" style="overflow: hidden">
        <@prop.select label="${action.getText('crude.micronixnet.prototype', 'Prototipo')}" name="prototype" value="${action.getCardParam('prototype')!''}" options=publischedObject force=true/>
        ...
        <@prop.select label="${action.getText('crude.micronixnet.only_detail', 'Solo dettaglio')}" name="only_detail" value="${action.getCardParam('only_detail')!'false'}" options=yes_noHash />
