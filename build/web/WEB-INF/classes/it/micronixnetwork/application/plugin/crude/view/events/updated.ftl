...
$(document).ready(function(){		
	...
	<#if uiid='view_ui'>
		...
		<#else>
			...
			${cardId}_set_list_message('<span id="${cardId}_event_message" class="event_message animated flash"><@s.text name="crude.update.success.message"/></span>');
		</#if>		
	</#if>
...
<span id="${cardId}_event_message" class="${cardId}_event_message animated flash"><@s.text name="crude.update.success.message"/></span>
</#if>
