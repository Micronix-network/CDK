...
<#assign list_view=type_flag!='d'/>
<#assign entity_view=type_flag!='l'/>
...
function ${cardId}_controller_event(parentCardId,$row,name){
...
$(document).ready(function(){
    ...
    $('#${cardId}_${prototypeName}_info_list_button').click(function(){
        ...
        <#if crud_observers!=''>		 
            <@js.notify_observer crud_observers=crud_observers event_name='to_list_click'/>
        </#if>
    });
