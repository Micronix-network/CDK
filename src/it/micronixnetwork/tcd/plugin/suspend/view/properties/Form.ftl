...
<#assign activeHash={'5':'5','10':'10', '15':'15', '20':'20', '30':'30'}/> 
...
<div id="propstabs_${cardId}" style="min-height:300px;">
	...
	<@prop.select label="${action.getText('crude.micronixnet.prototype', 'Prototipo')}" name="prototype" value="${action.getCardParam('prototype')!''}" options=domainObjects />
